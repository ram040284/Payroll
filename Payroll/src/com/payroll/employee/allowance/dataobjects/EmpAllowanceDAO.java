...
public class EmpAllowanceDAO {
		...
		List<EmpAllowanceVO> empAllowanceList = null;
			...
			try{
				String queryString = " select new com.payroll.employee.allowance.vo.EmpAllowanceVO(a.employee.employeeId, "
						...
						+ "a.nonPracAwance, a.uniformAlwance, a.familyPlanAlwance, a.cycleAlwance, a.hraFlag,a.qtrFlag, a.afkFlag, a.taFlag, a.pfFlag, a.otherAllowance) "
		...
		EmpAllowanceVO empAllowanceVO = null;
			...
			try{
				String queryString = " select new com.payroll.employee.allowance.vo.EmpAllowanceVO(a.employee.employeeId, "
						...
						+ "a.cca, a.washingAlwance, a.nonPracAwance, a.uniformAlwance, a.familyPlanAlwance, a.cycleAlwance, a.hraFlag, a.qtrFlag,a.afkFlag, a.taFlag, a.pfFlag, a.otherAllowance) from EmpAllowance a "
	...
	public EmployeeAllowances getEmployeeAllowances(int empId){
		EmployeeAllowances employeeAllowances = null;
			Session session = null;
			try{
				String queryString = "select new com.payroll.employee.allowance.vo.EmployeeAllowances(a.employeeId, a.cca, a.washingAlwance,a.nonPracAwance,a.uniformAlwance,a.familyPlanAlwance, a.cycleAlwance,a.hraFlag,a.qtrFlag,a.afkFlag, a.taFlag, a.pfFlag, a.otherAllowance) from EmpAllowance a where a.employeeId = ? and a.status = ?";		
