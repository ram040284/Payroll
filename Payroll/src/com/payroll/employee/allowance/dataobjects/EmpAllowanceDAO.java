...
public class EmpAllowanceDAO {
	...
	public EmployeeAllowances getEmployeeAllowances(int empId){
		EmployeeAllowances employeeAllowances = null;
			Session session = null;
			try{
				String queryString = "select new com.payroll.employee.allowance.vo.EmployeeAllowances(a.employeeId, a.cca, a.washingAlwance,a.nonPracAwance,a.uniformAlwance,a.familyPlanAlwance, a.cycleAlwance,a.hraFlag,a.qtrFlag,a.afkFlag, a.taFlag, a.pfFlag, a.otherAllowance, a.tAllowance) from EmpAllowance a where a.employeeId = ? and a.status = ?";		
