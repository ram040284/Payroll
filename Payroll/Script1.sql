...
CREATE TABLE EMP_ADV_DETAIL (
	...
	CONSTRAINT UNIQUE(ADV_ID, EMP_ID, STATUS)
) ENGINE=InnoDB;
...
CREATE TABLE EMP_DEDUCTION_DETAILS (
	EMP_ID INT,
	AFK_RENT DOUBLE, /* Monthly*/
	SOCITY DOUBLE,   /* Monthly*/
	ELECT_RCVRY DOUBLE,  /* Monthly*/
...
CREATE TABLE USER_ROLES (
  ...
  FOREIGN KEY (USR_ID) REFERENCES USER_MASTER (USR_ID_PK)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE EMP_SAL_MASTER MODIFY COLUMN SCALE_PAY VARCHAR(40);

ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN LOAN_PRINCIPAL DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN SCHOOL_FEE DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN LIC DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN MUTUAL_FUND DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN SEC_80D DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN SEC_80E DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN NSC DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN PPF DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN DONATION DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN SEC_80DD DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN BONUS DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN ARREARS DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN OT_AMOUNT DOUBLE;
ALTER TABLE EMP_TAX_DEDUCTION ADD COLUMN OT_WAGES DOUBLE;

ALTER TABLE DEPT_MASTER ADD COLUMN SECTION VARCHAR(64);
ALTER TABLE DEPT_MASTER ADD COLUMN DESCRIPTION VARCHAR(80);