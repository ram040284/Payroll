...
CREATE TABLE EMP_PENSION_PAY_BILL (
	EMP_ID VARCHAR(10),
	BASIC_PENSION DOUBLE,
	DA DOUBLE,
	TOTAL_PENSION_DEDUCTION DOUBLE,
	NET_PENSION DOUBLE,
	RESIDUAL_PENSION DOUBLE,
	DEARNESS_RELIEF DOUBLE,
	ARREARS DOUBLE,
...
CREATE TABLE PAY_BILL(
	...
	END_DATE DATE,
	ENGAGEMENT_LETTER_ID VARCHAR(15),
	FOREIGN KEY (EMP_ID) REFERENCES EMP_MASTER (EMP_ID),
	CONSTRAINT UNIQUE(EMP_ID, MONTH_DATE)
)ENGINE=InnoDB;
...
CREATE TABLE EMP_CONTRACT (
	...
	ROW_UPD_DATE DATETIME,
	FOREIGN KEY (EMP_ID) REFERENCES EMP_MASTER (EMP_ID),
	CONSTRAINT UNIQUE (EMP_ID, ROW_UPD_DATE)
) ENGINE=InnoDB;