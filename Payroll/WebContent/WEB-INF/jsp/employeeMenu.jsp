		...
		<div class="container">
			<div class="row">
				<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
					<h3><a href="#" onclick="getList('../Payroll/employee')">Employee Details</a></h3>
					</div>
				</div>
				...
				<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
					<h3><a href="../Payroll/viewBank">Employee Bank</a></h3>
					</div>
				</div>
				...
				<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
						<h3><a href="../Payroll/viewSalary">Employee Salary</a></h3>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
						<h3><a href="#" onclick="getList('../Payroll/viewLeave')">Employee Leave</a></h3>
					</div>
				</div>
				...
				<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
						<h3><a href="../Payroll/viewEmpPf">Provident Fund</a></h3>
					</div>
				</div>
				<div class="col-xs-4 text-center">
					<div class="precess-column">
					...
					alt="theme logo" /></a>
						<h3><a href="../Payroll/viewEmpQtr">Employee Quarters</a></h3>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
						<h3><a href="../Payroll/viewEmpLic">Employee LIC</a></h3>
					</div>
				</div>
					<div class="col-xs-4 text-center">
					<div class="precess-column">
					...
					alt="theme logo" /></a>
						<h3><a href="../Payroll/viewEmpAlwnce">Employee Allowances</a></h3>
					</div>
				</div>
			 	...
			 	<div class="col-xs-4 text-center">
					...
					alt="theme logo" /></a>
						<h3><a href="../Payroll/viewOvertime">Employee Overtime</a></h3>
					</div>
				</div>
			</div>
