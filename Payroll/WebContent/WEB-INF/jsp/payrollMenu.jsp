		...
		<div class="container">
			<div class="row">
				<div class="col-xs-4 text-center">
					...
					<a href="../Payroll/generateBills"><img src="../Payroll/resources/images/costhead1.png" class="img-responsive imageMenuItem" 
					alt="theme logo" /></a>
					<h3><a href="../Payroll/generateBills">Generate Paybills</a></h3>
					</div>
				</div>
