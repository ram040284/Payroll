...
$(document).ready(function() {
	...
	$('#addLicBtn').click(function(event) {
		...
		if($('#paymentAmount').val() < 1){
			alert("Payment Amount must be provided!");
			$('#paymentAmount').focus();
			return false;
		}
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-sm-6 form-group">
									...
									<form:input path="paymentDate"  id="paymentDate" placeholder="Enter Payment Date" class="form-control"/>
									
								</div>
								<div class="col-sm-6 form-group">
									<label>Payment Amount:</label>
									<form:input path="paymentAmount"  id="paymentAmount" placeholder="Enter Payment Amount" class="form-control"/>
