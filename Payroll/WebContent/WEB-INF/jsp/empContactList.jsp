...
$(document).ready(function() {
	...
	$('#empContactTable').DataTable({
		...
		"paging" : $('#empContactTable tbody tr').length>10,
		"displayLength": 10,
	  	"filter" : false,
	  	"lengthChange" : false,
	  	"autoWidth" : false,
...
function viewEmpContact(id){
	...
	f.action="../Payroll/viewEmpContact";
	f.submit();
}
function searchEmps(){
	...
	f.action="../Payroll/empContactListSearch";
	f.submit();
}
...
<body><%-- onload="getList()">--%>
	...
	<div class="contain-wrapp bodyDivCss">
		...
		<div class="container">
		<h5 style="color: #0101DF;">Employee Contact Details</h5>
		...
		<div style="margin-top: 6px; float: left; width: 100%;">
			...
			<thead>
				...
				<tr>
					...
					<td><a href="#" onclick="viewEmpContact('${employee.employeeId}')" title="Edit">
